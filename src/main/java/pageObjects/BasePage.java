...
public class BasePage {
	...
	public void mouseOver(WebElement element) {
		...
		ac.moveToElement(element).moveToElement(driver.findElement(By.id(""))).sendKeys("").doubleClick().build()
				.perform();
	...
	public void captureSnapshot(String name) throws IOException {
		...
		FileHandler.copy(snap, new File("D:\\OxygenWorkSpace\\OnlineTransactions\\target\\" + name + ".png"));
	}
